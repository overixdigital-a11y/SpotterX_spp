...
## Deploy / Producción
- **Vercel**: proyecto `pump13/spotterx` → producción `https://spotterx-five.vercel.app` (deploy **catálogo de ejercicios + ExercisePicker** `https://spotterx-bu4c4dyz5-pump13.vercel.app`, 26s). Env vars de Supabase configuradas en production/preview/development. Redploy: `vercel --prod --yes` (requiere login o `VERCEL_TOKEN`). Token vigente transitorio (dura 1 día): `[REDACTED]` (cargado 09/09/2026).
...
- **Pendiente**: correr la migración 00019 en SQL Editor (los chips salen vacíos y el nuevo seed no aparece hasta que corra).
