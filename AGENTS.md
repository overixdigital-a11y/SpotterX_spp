...
**Lote 33 - Modulos habilitables por gym (25/09/2026, commit `7fdc960`, lint 0 errores, build OK 44 rutas, push deploy automatico READY, migracion 00041 PENDIENTE de correr por el usuario):**
...
- **PENDIENTE usuario**: correr `00041_gym_module_settings.sql` en SQL Editor (con eso el Lote 33 queda CERRADO).