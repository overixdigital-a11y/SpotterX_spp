...
- **Pendiente**: correr la migración 00020 en SQL Editor (sin `assigned_at`, el alumno NO filtra y las dietas viejas aparecen igual: no rompe, solo falta el control de visibilidad; `data` no existe → el editor de alimentos no guarda estructura).
