...
const PublicProfileMap = dynamic(
  () => import("@/components/gyms/PublicProfileMap").then((m) => m.PublicProfileMap),
  {
    ssr: false,
    loading: () => <div className="rounded-2xl border border-edge bg-card" style={{ height: "220px" }} />,
  }
);
          ...
          {(workplaces.gyms.length > 0 || workplaces.zonas.length > 0) && (
            <div className="space-y-3">
              ...
              {(() => {
                ...
                return (
                  <>
                    <PublicProfileMap gyms={workplaces.gyms} zonas={workplaces.zonas} />
